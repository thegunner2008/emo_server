...
def search(term, num_results=10, lang="vi", proxy=None, advanced=False, sleep_interval=0, timeout=5, safe="active", ssl_verify=None, region="VN"):
    ...
    while fetched_results < num_results:
        ...
        for result in result_block:
            ...
            if not advanced and link:
                fetched_results += 1
                new_results += 1
                yield link["href"]

            if advanced and link and title and description_box:
